...
namespace Doctrina.ExperienceApi.Server.Resources
{
    ...
    public interface IActivityProfileResource
    {
        ...
        Task<ActivityProfileDocument> GetActivityProfile(Iri activityId, string profileId, Guid? registration, CancellationToken cancellationToken);
        ...
        Task<ActivityProfileDocument> CreateProfile(Iri activityId, string profileId, byte[] body, string contentType, Guid? registration, CancellationToken cancellationToken);
