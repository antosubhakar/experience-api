...
namespace Doctrina.ExperienceApi.Server.Resources
{
    ...
    public interface IStateResource
    {
        ...
        /// </summary>
        Task<MultipleDocumentResult> GetActivityStates(Iri activityId, Agent agent, Guid? registration = null, DateTimeOffset? since = null, CancellationToken cancellationToken = default);
